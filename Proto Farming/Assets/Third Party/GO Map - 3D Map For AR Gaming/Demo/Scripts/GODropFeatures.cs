...
namespace GoMap {
	...
	public class GODropFeatures : MonoBehaviour {
		...
		void dropTestPin() {
			...
			//1) create game object (you can instantiate a prefab 


			//2) make a Coordinate class with your desired latitude longitude
			Coordinates coordinates = new Coordinates (47.45357637773786,19.050977841291797);
			goMap.dropPin(coordinates, this.gameObject);
